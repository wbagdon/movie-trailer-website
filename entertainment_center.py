...
movies.append(media.Movie(
    ...
    a promise to his beloved that he'll retrieve a fallen star by venturing \
...
movies.append(media.Movie(
    ...
    "1999",
    "Fraternal twins set out to rid Boston of the evil men \
    operating there while being tracked down by an FBI agent."
    ))
movies.append(media.Movie(
    "Spaceballs",
    ...
    "1987",
    "Planet Spaceball's President Skroob sends Lord Dark Helmet \
    to steal Planet Druidia's abundant supply of air to replenish \
...
movies.append(media.Movie(
    ...
    "2014",
    "Still on the run from a group of Nazi zombies, \
    a man seeks the aid of a group of American zombie enthusiasts, \
